const dictionaries: any = {
    en: {
        ...
        stats: 'Base Stats',
        close: 'Close',
        message: 'This website is generated in NEXT by the student xxxx from IES Cura Valera.',
    ...
    es: {
        ...
        stats: 'Estadísticas',
        close: 'Cerrar',
        message: 'Esta web está generada en NEXT por el alumno xxxx del IES Cura Valera.',
    ...
    fr: {
        ...
        stats: 'Statistiques',
        close: 'Fermer',
        message: 'Ce site web est généré en NEXT par l\'étudiant xxxx de l\'IES Cura Valera.',
